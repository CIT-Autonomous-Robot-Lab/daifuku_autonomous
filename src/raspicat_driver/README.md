...
パラメータは `src/daifuku_config/bringup/robot/raspicat_driver.yaml`（全キーを既定値の
まま列挙。値の由来は [`src/daifuku_config/README.md`](../../src/daifuku_config/README.md)）。
